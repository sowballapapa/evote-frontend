...
@Component({
  selector: 'app-admin-acc-collectors-index',
  standalone: true,
  imports: [
    AccPaginateTableComponent
  ],
  templateUrl: './admin-acc-collectors-index.component.html',
  styleUrl: './admin-acc-collectors-index.component.css'
})
export class AdminAccCollectorsIndexComponent {

  @ViewChild(AccPaginateTableComponent, {static: true}) paginator!: AccPaginateTableComponent;
  private _unsubscribeAll: Subject<any>;

  constructor(private collectorService: UserCollectorService) {
    this._unsubscribeAll = new Subject();
  }
  allUsers:any
  fetchTitle = "Liste des comptes Collecteurs"
  isLoading = false;
  lastPage = 1
  currentPage = 1
  pageSize = [1]
