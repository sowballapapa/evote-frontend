...
@Component({
  selector: 'app-admin-g-sponsorships-participations',
  standalone: true,
  imports: [
    NgIf,
    NgClass,
  ...
  templateUrl: './admin-g-sponsorships-participations.component.html',
  styleUrl: './admin-g-sponsorships-participations.component.css'
})
export class AdminGSponsorshipsParticipationsComponent {
